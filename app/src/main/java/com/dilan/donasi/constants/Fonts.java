package com.dilan.donasi.constants;
...
public class Fonts {
    ...
    public static String MONTSERRATREGULAR = "montserrat_regular";
    public static String MONTSERRATLIGHT = "montserrat_light";
    public static String MONTSERRATMEDIUM = "montserrat_medium";
    public static String MONTSERRATBLACK = "montserrat_black";
    public static String MONTSERRATBOLD = "montserrat_bold";
    public static String MONTSERRATTHIN = "montserrat_thin";
